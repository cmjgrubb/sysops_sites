...
exports.create = (req, res) => {
  ...
  const sysops = new Sysops({
    ...
    MotorHP: req.body.MotorHP,
    TempPower: req.body.TempPower,
    ElectricCoop: req.body.ElectricCoop,
    AccountNumber: req.body.AccountNumber,
    MeterNumber: req.body.MeterNumber,
    GridName: req.body.GridName,
    TransLocation: req.body.TransLocation,
    Force: req.body.Force,
    Gravity: req.body.Gravity,
    PumpsTo: req.body.PumpsTo,
    ForceConnection: req.body.ForceConnection,
